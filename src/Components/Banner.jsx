        ...
        <div className="bg-plataniamColor dark:bg-darkbg">
            <div className=" container">
                <div className="relative">
                    ...
                    <div className="absolute top-0 left-0 rounded-md w-full h-full flex justify-end items-center">
                        <div className="max-w-xl flex flex-col gap-4 p-1">
                            <h1 className="text-xl md:text-2xl lg:text-3xl font-bold text-blueColor text-center">Unlocking the World of Knowledge: Your Study Destination</h1>
                            <p className="text-center mt-5 hidden md:flex text-blueColor">
