                        ...
                        <div className="flex-1 space-y-3 min-h-full flex gap-3 flex-col justify-between">
                            ...
                            <div className="bg-whiteColor dark:bg-lightdarkbg rounded-md p-2 h-[50%]">
                                <div className="h-full flex flex-col justify-between">
                                    ...
                                    <button
                                        className="bg-blueColor p-2 w-full rounded-md text-whiteColor h-[50%] hover:bg-whiteColor dark:hover:bg-lightdarkbg dark:text-whiteColor hover:text-blueColor transition-all duration-300 border border-blueColor flex justify-center items-center text-xl font-bold">
                    ...
                    <div className='flex flex-col lg:flex-row justify-between gap-5 items-center border border-orangeColor rounded-md p-3 space-y-3 md:flex-col'>
                        ...
                        <div className='w-full flex-1 flex flex-col md:flex-row gap-5'>
                            ...
                            <div className='flex gap-3 flex-col flex-1'>
                                <h2 className='bg-whiteColor dark:bg-lightdarkbg p-2 px-3 rounded-md text-center text-2xl font-semibold text-blueColor'>{assignmentTitle}</h2>
                                <div className='bg-whiteColor dark:bg-lightdarkbg p-2 px-3 rounded-md text-center'>
                                    <p className='text-blueColor font-semibold text-xl'>Submit By:</p>
                                    <p>{submitBy}</p>
                                </div>
                                <div className='flex gap-5'>
                                    <div className='bg-whiteColor dark:bg-lightdarkbg p-2 px-3 rounded-md text-center flex-1'>
                                ...
                                <div className='bg-whiteColor dark:bg-lightdarkbg p-1 px-3 rounded-md text-center flex flex-col justify-center items-center gap-1'>
                                    <p className='text-xl text-blueColor font-semibold'>Submit Date</p>
                                    <p>{submitDate}</p>
                                </div>
                            </div>
                            ...
                            <div className='flex-1 text-center flex flex-col gap-5 justify-between '>
                                <div className='flex flex-col gap-5 bg-whiteColor dark:bg-lightdarkbg p-2 px-3 rounded-md text-center flex-1'>
                                ...
                                <div className='flex flex-col gap-5 bg-whiteColor dark:bg-lightdarkbg p-2 px-3 rounded-md text-center flex-1'>
                                    ...
                                    <button
                                        className="bg-blueColor p-2 w-full rounded-md text-whiteColor h-[50%] hover:bg-whiteColor dark:hover:bg-darkbg dark:text-whiteColor hover:text-blueColor transition-all duration-300 border border-blueColor flex justify-center items-center text-xl font-bold">
                                        <Link to={projectFile} target="_blank">
                                            Read The Submission
                                        </Link>
                                    </button>
